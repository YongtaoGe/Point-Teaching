...
from .mil_fcos_outputs_v2 import MIL_FCOSOutputs
    ...
    def forward(self, images, features, gt_instances=None, branch="supervised",
        ...
        if self.training:
            if branch == "supervised":
                ...
                results["proposals_rpn"] = self.fcos_outputs.predict_rpn_proposals(locations, ctrness_pred, reg_pred, images.image_sizes)
